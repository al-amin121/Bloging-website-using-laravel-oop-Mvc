                                ...
                                <div class="table-responsive">
                                    <table id="data-table" class="table text-nowrap mb-0 table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0">Category Image</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >{{$category->name}}</a></td>
                                            <td class="text-muted fs-13 text-center">
                                                <span class="data-image avatar avatar-md " style="background-image: url({{asset($category->image)}})"></span>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-stretch">
                                                    @if($category->status ==1)
                                                        <a class="btn btn-sm btn-danger mt-3 italic" href="{{route('category.status',['id'=>$category->id])}}">Inactive</a>
                                                    @else
                                                        <a class="btn btn-sm btn-success mt-3 italic" href="{{route('category.status',['id'=>$category->id])}}">Active</a>
                                                    @endif
                                                    <a href="{{route('category.edit',['id'=>$category->id])}}" class="btn btn-sm btn-outline-success border me-4 ms-5" data-bs-toggle="tooltip" data-bs-original-title="Edit">
